...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field 'hathitrust_struct', label: 'HathiTrust Access', helper_method: :hathi_access, hide_label: true
    ...
    config.add_show_field 'hathitrust_struct', label: 'HathiTrust Access', top_field: true, helper_method: :hathi_access, hide_label: true, if: false
