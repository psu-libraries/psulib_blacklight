...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field 'originals_loc_ssm', label: 'Location of Original'
    ...
    config.add_show_field 'administrative_history_note_ssm', label: 'Administrative Note'
    ...
    # Maybe this is Contents. Probably.
    config.add_show_field 'toc_ssim', label: 'Table of Contents'

    # Not sure where these should go order-wise.
    ...
    config.add_show_field 'references_note_ssm', label: 'References'
