...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field 'score desc, pub_date_sort desc, title_ssort asc', label: 'relevance'
    config.add_sort_field 'pub_date_sort desc, title_ssort asc', label: 'year'
    config.add_sort_field 'author_ssort asc, title_ssort asc', label: 'author'
    config.add_sort_field 'title_ssort asc, pub_date_sort desc', label: 'title'
