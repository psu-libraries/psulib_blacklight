    ...
    task :create_fixtures do
      ...
      response = solr.get 'select', params: {
        ...
        fl: 'id, marc_display_ss, all_text_timv, language_facet_ssim, format, isbn_ssim, material_type_display_ssm,
             ...
             author_ssort, subject_tsim, subject_addl_tsim, subject_topic_facet_ssim, published_display_ssm,
             published_vern_display_ssm, pub_date_ssim, series_title_tsim, series_title_display_ssm,
             lc_callnum_display_ssm, lc_1letter_facet_sim, lc_alpha_facet_sim, lc_b4cutter_facet_sim,
             url_fulltext_display_ssm, url_suppl_display_ssm, all_authors_facet_ssim',
        sort: 'id desc',
        rows: 100,
        wt: :json
      }
