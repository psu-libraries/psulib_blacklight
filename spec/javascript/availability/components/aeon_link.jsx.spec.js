...
describe('when all fields are present', () => {
  const moreParams = '&Location=item%20location&ItemNumber=item%20ID&CallNumber=123' +
...
test('renders an Aeon link with some fields missing', async () => {
  ...
  const href = baseUrl +
    '&ReferenceNumber=456&Genre=BOOK&Location=item%20location' +
