...
RSpec.describe 'Call Number Browse' do
  context 'when Browse by LC Call Numbers' do
    context 'when the user is not searching for a particular call number' do
      specify do
        ...
        expect(page).to have_css 'h2.h4',
                                 exact_text: 'AP3.M33 to BM516.B5134 1948'

        expect(page).to have_no_css '.table-primary'

        expect(page).to have_link('AP2.O354', href: '/catalog/107')
        expect(page).to have_css 'tr:nth-child(4) td:nth-child(2)',
                                 exact_text: 'The Christmas locket'
        expect(page).to have_css 'tr:nth-child(4) td:nth-child(3)',
                                 exact_text: 'Special Collections Library'
        expect(page).to have_css 'tr:nth-child(4) td:nth-child(4)',
    ...
    context 'when the user is searching for a particular call number' do
      context 'when there is an exact match' do
        specify do
          ...
          expect(page).to have_css 'tr.table-primary:nth-child(2) td:nth-child(2)',
                                   exact_text: 'Adventures in the wilderness, or, Camp life in ' \
                                               'the Adirondacks / By William H.H. Murray ...'

          expect(page).to have_css 'tr.table-primary:nth-child(2) td:nth-child(3)',
                                   exact_text: 'Annex / Special Collections Library'

          expect(page).to have_css 'tr.table-primary:nth-child(2) td:nth-child(4)',
      ...
      context 'when there is not an exact match' do
        specify do
          ...
          expect(page).to have_css 'tr.table-primary:nth-child(2) td',
  ...
  context 'when Browse by DEWEY Call Numbers' do
    context 'when the user is not searching for a particular call number' do
      specify do
        ...
        expect(page).to have_css 'tr:nth-child(2) td:nth-child(2)',
                                 exact_text: 'An international bibliography on atomic energy'
        expect(page).to have_css 'tr:nth-child(2) td:nth-child(3)',
                                 exact_text: 'Annex'
        expect(page).to have_css 'tr:nth-child(2) td:nth-child(4)',
